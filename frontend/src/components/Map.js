...
function Map(props) {
  ...
  return (
    <div>
      <ReactMapGL className='mt-1 mr-9 map' {...viewport} onDblClick={handleDblClick} doubleClickZoom={false} mapStyle={'mapbox://styles/dna5769/ckn4km6x31sob17nzox3gjzdz'} onViewportChange={viewport => setViewport(viewport)} mapboxApiAccessToken={'pk.eyJ1IjoiZG5hNTc2OSIsImEiOiJja24zaXJzdG4xaHJuMnFwZnA4amc4a21jIn0.w2esHLkzt3LfxhQif-rm8w'}>
